  ...
  return (
    <>
      ...
      {isTosOpen && (
        ...
        >
          <div
            className="bg-gray-900 border border-red-600 max-w-3xl w-full mx-4 rounded-2xl shadow-2xl overflow-hidden"
            ...
            <div className="p-4 max-h-[70vh] overflow-y-auto text-white/70 text-[10px] sm:text-xs md:text-sm font-pokemon space-y-3 leading-relaxed">
              ...
              <div>
                ...
                <p>
                  ...
                  Credits can only be used for non-random or skill-based features, such as bidding on known
                  items, cosmetic profile enhancements, or other non-luck-based activities.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  cosmetic items, or other optional interactivity). Rollover Credits do not increase a User’s
                  odds in any random drawing and may not be exchanged for money or value. Promotional or
                  marketing Credits (“Bonus Credits”) may be issued at the Company’s discretion for
                  limited-time campaigns, referrals, or loyalty rewards. Bonus Credits are non-purchasable,
                  non-redeemable, and do not alter or enhance odds of winning in any random event.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  draws and the maximum Credit cost per draw are fixed for each Stream, ensuring all
                  participants have equal opportunity regardless of Credit balance or previous participation.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  events. Participation in such features does not affect or depend on the outcome of any
                  random element of the Stream.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  (d) The platform is structured to comply with all applicable contest, sweepstakes,
